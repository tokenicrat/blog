...
- VLESS-Vision-REALITY 直连几乎免封。
- Hysteria2 极大提升烂线路 VPS 体验。
- 硬件上，RackNerd 等质量尚可的平价 VPS 商家出现。

自建的体验与成本对比可以接受，结合其原有 IP 独立、协议灵活等优势，可以说，如果什么时候最适合选择自建的话，那就是现在了 😎

另外提醒您：近期（2025 年 7 月）净网力度较强，大量境内服务器被停机封禁，叠加大面积 DDoS，以及追踪订阅链接 IP 封禁，机场（尤其是中转和专线）稳定性很低，不建议订阅。[^3]

[^3]: [机场服务频繁中断背后：双重打击下的网络代理困局分析](https://linux.do/t/topic/779511)，权限帖，需要注册。
...
选定配置组合，然后可以选择地区和操作系统。词元接下来会以 Rocky Linux 9 为例操作，如果不熟悉 Linux 建议选择相同的，方便下面操作。
